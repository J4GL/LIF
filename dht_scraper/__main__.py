...
from dht_scraper.fetch_worker_pool import DEFAULT_FETCH_WORKERS
...
def parse_arguments(argv: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--fetch-workers", type=int, default=DEFAULT_FETCH_WORKERS, help="metadata fetch threads (default %d)" % DEFAULT_FETCH_WORKERS)
...
def run_scraper(args: argparse.Namespace) -> int:
    ...
    runtime = ScraperRuntime(settings, TorrentCatalog(), fetch_metadata, DEFAULT_BOOTSTRAP_NODES)
    try:
