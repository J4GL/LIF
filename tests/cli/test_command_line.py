...
class ParseArgumentsTest(unittest.TestCase):
    ...
    def test_defaults(self):
        ...
        self.assertEqual((args.fetch_workers, args.batch_size, args.interval, args.duration), (32, 5, 0.1, None))
    ...
    def test_invalid_values_exit(self):
        invalid = [
            ...
            ["--web-port", "-1"], ["--fetch-workers", "0"], ["--fetch-workers", "257"], ["--batch-size", "0"],
